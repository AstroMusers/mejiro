...
class HWO(InstrumentBase):
    ...
    def set_pixel_scale(self): 
        ...
        self.pixel_scale[0:2] = 1.22*(self.pivotwave[2]*0.000000001)*206264.8062/self.aperture / 2.   # UV set at U 
        self.pixel_scale[2:-3] = 1.22*(self.pivotwave[2]*0.000000001)*206264.8062/self.aperture / 2.   # Opt set at U 
        self.pixel_scale[-3:] = 1.22*(self.pivotwave[7]*0.000000001)*206264.8062/self.aperture / 2.   # NIR set at J 
