...
# TODO needs to be updated; see get_snr method above
def get_snr_hwo(gglens, band):
    total_image, _, source_surface_brightness = get_image_hwo(gglens, band)
...
# TODO likewise, needs to be updated; see get_image above
