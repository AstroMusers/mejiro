...
#     lens = StrongLens(kwargs_model=kwargs_model, kwargs_params=kwargs_params, lens_mags=lens_mags,
#                       source_mags=source_mags, lens_stellar_mass=lens_stellar_mass, lens_vel_disp=lens_vel_disp,
#                       snr=snr, uid=uid)
