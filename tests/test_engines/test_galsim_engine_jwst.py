...
def test_jwst_pieces():
    ...
    assert synthetic_image.data.shape == (163, 163)
    ...
    assert exposure.data.shape == (163, 163)
    assert exposure.lens_data.shape == (163, 163)
    assert exposure.source_data.shape == (163, 163)
