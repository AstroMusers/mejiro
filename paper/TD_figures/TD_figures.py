...
def main(config):
    ...
    arg_list = [(lens, psf, roman, band, side, grid_oversample, instrument_params, exposure_time) for lens in lenses[:num_figures]]
...
def generate_figures(args):
    ...
    # Unpack tuple
    lens, psf, roman, band, side, grid_oversample, instrument_params, exposure_time = args
