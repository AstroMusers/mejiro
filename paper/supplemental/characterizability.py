...
def process_lens(lens, roman, band, scene_size, oversample, kwargs_numerics, instrument_params, psf, rng, exposure_time, snr_quantile, save_dir):
...
def main(config):
    ...
    with ProcessPoolExecutor(max_workers=process_count) as executor:
        futures = [executor.submit(process_lens, lens, roman, band, scene_size, oversample, kwargs_numerics, instrument_params, psf, rng, exposure_time, snr_quantile, save_dir) for lens in detectable_lenses]
